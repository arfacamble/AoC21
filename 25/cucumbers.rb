...
DATA = 'v>.v.>.v..>...v..v>>>.v..>.>>vvv.v>..v.v...>v...v.v>>.>.v.>.>.vv.>v..>vv>.v>>>>.>...>.>>v..v>>vvv.v......v..>v..>>>.vv.vv..>.v.v>v>>.>v.v>v
...
def parse(input)
    ...
    rows.each_with_index do |row, y|
        map[y] = {}
        row.split('')
           .each_with_index { |obj, x| map[y][x] = obj unless obj == '.' }
    end
    {
        height: height,
        width: width,
...
# EXAMPLE.each do |_y, row|
#     row.each { |_x, obj| print obj }
#     puts ' '
# end